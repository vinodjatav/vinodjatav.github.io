...
export const CheckCircleIcon = (props: SvgIconProps) => {
    return (
        <SvgIcon {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
            <circle cx="12" cy="12" r="10" fill="none" stroke="#fff" strokeWidth="1" />
            <path d="M5.293 11.707L10 16.414l8.707-8.707-1.414-1.414L10 13.586 6.707 10.293l-1.414 1.414z" fill="#fff" stroke="#fff" strokeWidth="1.5" />
        </SvgIcon>
    );
};